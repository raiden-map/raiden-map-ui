          ...
          var grdetailsadd=[];
             resp.data.RAIDEN_DELTA.forEach(element => {
              if(element.key==key) {
                  ...
                  dataset1.push(element.datakey.tokenNetworksChanges[key].openChannels);
                  dataset2.push(element.datakey.tokenNetworksChanges[key].closedChannels);
                  }
              }  
             });
